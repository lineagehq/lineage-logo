...
7. Verify responsive and keyboard/assistive-technology paths, broader browser matrix, fixture corpus and D3 measurements. Run the complete local checks and inspect every expected CI job at the final head. Under merge authorization, inspect the resulting main CI too.
