...
The delayed-open regression runs explicitly in the PR/main Chromium job after browser installation. Unit-only jobs leave that browser-backed case gated; it is not omitted from CI acceptance.
